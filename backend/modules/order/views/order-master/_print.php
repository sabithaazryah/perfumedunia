        ...
        <div class="container" style="border: 1px solid #5a5959;">
            ...
            <div>
                ...
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;padding-left: 10px;">
                    ...
                    $tax = common\models\Cart::tax($order_details);
                    ?>
                </table>
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;">
                    ...
                    <tr>
                        ...
                        <td style="width:15%"></td>
                        <td style="width:15%"></td>
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $tax); ?></span></td>
                    </tr>
                </table>
                <?php $grand_total = $amount_total + $delivary_charge + $tax - $promotion_disvount; ?>
