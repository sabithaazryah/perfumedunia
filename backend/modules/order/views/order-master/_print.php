            ...
            <div>
                ...
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;padding-left: 10px;">
                    ...
                    foreach ($order_details as $value) {
                        ...
                        $producttax = common\models\Cart::productTax($product);
                        ...
                        <tr>
                            ...
                            <td style="width:15%"><span style="float: right;padding-right: 20px;"><?= sprintf('%0.2f', $value->amount - $producttax); ?></span></td>
                            <td style="width:20%"><span style="float: right;padding-right: 20px;"><?= sprintf('%0.2f', $rate); ?></span></td>
                        </tr>
                        <?php
                ...
                <table style="width: 100%;padding-bottom: 10px;border-bottom: 2px solid #5a5959;">
                    <tr>
                        ...
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $amount_total - $total_tax); ?></span></td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <td style="width:50%"><span style="float: right;font-weight: 600;padding-right: 20px;">Tax</span></td>
                        <td style="width:15%"></td>
                        <td style="width:15%"></td>
                        <td style="width:20%"><span style="float: right;font-weight: 600;padding-right: 20px;"><?= sprintf('%0.2f', $total_tax); ?></span></td>
                    </tr>
                </table>
