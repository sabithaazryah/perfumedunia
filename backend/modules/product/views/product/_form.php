                ...
                <div class="tab-pane active" id="general">
                        <div class="row" style="margin: 0 auto; padding: 15px 15px;">
                                <div class='col-md-12 col-sm-6 col-xs-12 '>
                                        <?= $form->field($model, 'main_category')->dropDownList(['1' => 'Fragrances', '2' => 'Watches', '3' => 'Jewellery', '4' => 'Eyewear', '5' => 'Accessories']) ?>
                                </div>
                                ...
                                <!--				<div class='col-md-4 col-sm-6 col-xs-12 '>
                                <?php // $form->field($model, 'product_type')->dropDownList(ArrayHelper::map(Fregrance::find()->all(), 'id', 'name'), ['prompt' => 'select']) ?>
                                ...
                                <!--				<div class='col-md-4 col-sm-6 col-xs-12 '>
                                <?php // $form->field($model, 'condition')->dropDownList(['1' => 'New', '0' => 'Refurbished']) ?>
                                                                </div>-->
                                <div class='col-md-4 col-sm-6 col-xs-12 '>
                                        <?php
                                        if (!$model->isNewRecord) {
