...
<div class="home-management-form form-inline">
        ...
        <div class='col-md-12 col-sm-12 col-xs-12 left_padd' style="<?= $model->isNewRecord ? '' : 'pointer-events:none' ?>">
                <div class='col-md-12 col-sm-12 col-xs-12 left_padd'>
                        <?= $form->field($model, 'type')->dropDownList(['5' => 'Latest product', '1' => 'Todays Exclusive', '2' => 'Single banner', '3' => 'Double Banner', '4' => 'Tripple Banner', '6' => 'New Arrivals']) ?>

                </div>
        </div>
        <div class='col-md-12 col-sm-12 col-xs-12 left_padd type-product' style="<?= $model->type == 5 || $model->type == 1 || $model->type == 6 ? 'display:block' : 'display:none' ?>">
