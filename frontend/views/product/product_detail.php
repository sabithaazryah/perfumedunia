                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 details">
                                ...
                                <div class="hr-box">
                                        <h5 class="sizes">sizes:
                                                ...
                                                ?>
                                                <span class="size active-box" data-toggle="tooltip" title=""><?= $product_details->size . $unit_name ?></span>
                                        </h5>
                                        <br/>
                                        <h5 class="type">Fragrance Type:
                                                <?php $fregrance = \common\models\Fregrance::findOne($product_details->product_type); ?>
                                                <span class="not-available active-box" data-toggle="tooltip" title=""><?php if(isset($fregrance->name) && $fregrance->name!=''){echo  $fregrance->name;} ?></span>
