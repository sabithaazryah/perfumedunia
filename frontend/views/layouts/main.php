        ...
        <div id="myModal" class="modal">
                ...
                <!--                    <span>LOGIN YOUR ACCOUNT</span>
                        ...
                        <div class="register-form">
                                ...
                                <input id="signup-email" type="text" name="User[email]" placeholder="Email*" >
                                <input type="hidden" name="email-check" id="email-check" value="0">
                                <div class='email-validations' style='color:red;margin-left: 4px;font-size: 11px;display:none'></div>
                        ...
                        if ($('#signup-email').val()) {
                                ...
                                if (!validateMail($(this).val())) {
                                        ...
                                        if (res == 0) {
                                                ...
                                                $('.email-validations').html('This email is already used.');
