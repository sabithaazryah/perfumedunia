				...
				<div class="container">
					<div class="row">
						<div class="col-md-3  col-sm-3 col-xs-3 left">
							...
							<marquee class="GeneratedMarquee" direction="left" scrollamount="5" behavior="scroll"><?php if(isset($your_own->content)) {echo  $your_own->content;} ?></marquee>
						</div>
								...
								<ul>
									...
									<li class="dropdown hidden-xs"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="truck"></i>Free Shipping</a>
										<ul class="dropdown-menu">
											<li><?php if(isset($shipping->content)) {echo  $shipping->content;} ?></li>
										</ul>
									</li>
				    <!--                                    <li class="dropdown hidden-lg hidden-md hidden-sm"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="truck"></i></a>
									...
									<li class="top-social">
										<a href="<?php if(isset($facebook->content)) {echo  $facebook->content;} ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
									</li>
									<li class="top-social"><a href="<?php if(isset($linkedin->content)) {echo  $linkedin->content;} ?>" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
									<li class="top-social"><a href="<?php if(isset($google->content)) {echo  $google->content;} ?>" target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-2 col-sm-4 col-xs-4" id="logo">
							<?= Html::a('<div class=""></div>', ['/site/index'], ['class' => '']) ?>
						</div>
...
//$category_main = $_GET['category'];
								...
								<ul class="nav navbar-nav">
									...
									<?php if (!empty($prod_main_catag)) { ?>
										...
										?>
										<li class=""><?= Html::a('<span>Womens</span>', ['/product/index', 'id' => 1], ['class' => '']) ?></li>
										<li class=""><?= Html::a('<span>Mens</span>', ['/product/index', 'id' => 2], ['class' => '']) ?></li>
										<li class=""><?= Html::a('<span>Oriental</span>', ['/product/index', 'id' => 3], ['class' => '']) ?></li>
										<li class=""><?= Html::a('<span>Gift Sets</span>', ['/product/index', 'id' => 4], ['class' => '']) ?></li>
										<li class=""><?= Html::a('<span>Brands</span>', ['/product/index', 'id' => 5], ['class' => '']) ?></li>
									<?php } ?>
				...
				<div class="row">
					...
					<div style="padding-left: 0px;" class="col-md-4 col-sm-4 col-xs-4 xs-50 br-left">
						...
						<div class="col-md-12 col-sm-12 hidden-xs foot-social">
							<ul>
								<li><a href="<?php if(isset($facebook->content)) {echo  $facebook->content;} ?>" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
								<!--<li><a href="<?php // echo $twitter->content;                                                                 ?>"target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>-->
								<li><a href="<?php if(isset($google->content)) {echo  $google->content;} ?>"target="_blank"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
								<li><a href="<?php if(isset($linkedin->content)) {echo  $linkedin->content;} ?>"target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
							</ul>
						</div>
					</div>
