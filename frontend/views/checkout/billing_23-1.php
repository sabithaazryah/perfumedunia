                                                            ...
                                                            <div class="fieldset" data-address-fields="">
                                                                ...
                                                                <div class="new_address_area">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padlft0 first-name">
                                                                        <?= $form->field($model, 'name')->textInput(['maxlength' => true, 'class' => 'field__input input-width billing', 'placeholder' => 'First Name', 'disabled' => 'disabled'])->label(FALSE) ?>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 padlft0 padright0 apt">
                                                                        <?= $form->field($model, 'location')->textInput(['maxlength' => true, 'class' => 'field__input input-width billing', 'placeholder' => 'Apt, suite, etc. (optional)', 'disabled' => 'disabled'])->label(FALSE) ?>
                                                                    </div>
