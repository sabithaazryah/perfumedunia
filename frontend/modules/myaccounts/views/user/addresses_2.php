                            ...
                            <div class="section__content">
                                <div class="fieldset" data-address-fields="">
                                    ...
                                    <div class="field field--optional field--half" data-address-field="name">
                                        ...
                                        <div class="form-row">
                                            <?= $form->field($model, 'name')->textInput(['class' => 'input-text', 'placeholder' => 'Name'])->label(FALSE); ?>
                                        </div>
                                    </div>
                                    <div class="field field--optional field--half" data-address-field="address">

                                        <div class="form-row">
                                            <?= $form->field($model, 'address')->textInput(['class' => 'input-text', 'placeholder' => 'Address'])->label(FALSE); ?>
                                        </div>
                                    </div>
                                    <div class="field field--optional field--half" data-address-field="landmark">

                                        <div class="form-row">
                                            <?= $form->field($model, 'landmark')->textInput(['class' => 'input-text', 'placeholder' => 'Landmark'])->label(FALSE); ?>
                                        </div>
                                    </div>
                                    <div class="field field--optional field--half" data-address-field="location">

                                        <div class="form-row">
                                            <?= $form->field($model, 'location')->textInput(['class' => 'input-text', 'placeholder' => 'Location'])->label(FALSE); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="field field--optional field--half" data-address-field="post_code">
                                        ...
                                        <div class="form-row">
                                            <?= $form->field($model, 'post_code')->textInput(['class' => 'input-text', 'placeholder' => 'post Code'])->label(FALSE); ?>
                                        </div>
                                    </div>
                                    <div class="field field--optional field--half" data-address-field="country_code">
                                        <div class="date-dropdowns" style="">
                                            ...
                                            <?= $form->field($model, 'mobile_number')->textInput(['class' => 'mobile form-control', 'placeholder' => 'Mobile Number', 'style' => 'padding-left: 70px;'])->label(FALSE) ?>
