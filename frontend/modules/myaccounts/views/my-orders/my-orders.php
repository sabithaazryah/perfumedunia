...
<div class="col-lg-12 col-md-8 col-sm-12 hidden-xs my-order-list">
        ...
        foreach ($order_products as $order_product) {
            ...
            <div class="ordered-pro-dtls">
                ...
                <div class="col-lg-6 col-md-6 col-sm-4 col-xs-4">
                    ...
                    <?= Html::a('<p class="cart-pro-heading">' . substr($product_detail->product_name, 0, 20) . '</p>', ['/product/product_detail', 'product' => $product_detail->canonical_name], ['target' => '_blank', 'title' => $product_detail->product_name]) ?>
        ...
        foreach ($order_products as $order_product) {
            ...
            <div class="ordered-pro-dtls">
                ...
                <div class="col-xs-9">
                    ...
                    <?= Html::a('<p class="cart-pro-heading">' . $name . '</p>', ['/product/product_detail', 'product' => $product_detail->canonical_name], ['target' => '_blank']) ?>
                    <?php
                    $label1 = '';
                    $label2 = '';
