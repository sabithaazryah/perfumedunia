                ...
                <div class="product-inner gp_products_inner" id="<?= $div_id ?>">
                        ...
                        <div class="product-meta">
                                <div class="warp-info">
                                        ...
                                        <!--quickview-->
                                        <a href="<?= Yii::$app->homeUrl . 'product-detail/' . $model->canonical_name ?>"  class="wpo-colorbox cboxElement quickview" data-productslug="ninja-silhouette-2"  data-target="#wpo_modal_quickview">
