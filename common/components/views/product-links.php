...
?>
<div class="shopcol col-lg-3 col-md-4 col-sm-4 col-xs-12 post-111 product type-product status-publish has-post-thumbnail product_cat-men product_cat-shirt product_cat-top featured shipping-taxable product-type-external product-cat-men product-cat-shirt product-cat-top instock">
                        ...
                        <div class="image">
                                <a href="<?= Yii::$app->homeUrl . 'product/product_detail?product=' . $model->canonical_name ?>">
                                        ...
                                        <?php } else { ?>
                                                ...
                                                <img src="<?= Yii::$app->homeUrl ?>images/products/4.png" class="image-effect wp-post-image" alt="product16" />
                                        <?php } ?>
                                </a>
